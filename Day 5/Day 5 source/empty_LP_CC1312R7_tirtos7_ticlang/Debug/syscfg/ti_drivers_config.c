 ...
 *
 *  DO NOT EDIT - This file is generated for the LP_CC1312R7
...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* LED_RED */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* LED_GREEN */
...
const uint_least8_t LED_RED_CONST = LED_RED;
const uint_least8_t LED_GREEN_CONST = LED_GREEN;
...
const Timer_Config Timer_config[CONFIG_TIMER_COUNT] = {
    /* Timer_0 */
    {
        .object    = &timerCC26XXObjects[Timer_0],
        .hwAttrs   = &timerCC26XXHWAttrs[Timer_0]
    },
};

const uint_least8_t Timer_0_CONST = Timer_0;
...
const GPTimerCC26XX_HWAttrs gptimerCC26XXHWAttrs[CONFIG_GPTIMER_COUNT] = {
    /* CONFIG_GPTIMER_0, used by Timer_0 */
    {
        .baseAddr = GPT0_BASE,
        .intNum      = INT_GPT0A,
        .intPriority = (~0),
